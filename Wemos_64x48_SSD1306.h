...
*********************************************************************/
#ifndef _Wemos_64x48_SSD1306_H_
#define _Wemos_64x48_SSD1306_H_
...
class Wemos_64x48_SSD1306 : public Adafruit_GFX {
 public:
  Wemos_64x48_SSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  Wemos_64x48_SSD1306(int8_t DC, int8_t RST, int8_t CS);
  Wemos_64x48_SSD1306(int8_t RST = -1);
